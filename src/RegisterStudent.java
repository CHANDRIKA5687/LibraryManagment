...
public class RegisterStudent extends javax.swing.JFrame {
   ...
   // @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        c1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Stream", "BTECH", "BCS", "BCA" }));
    ...
    private void c1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c1ActionPerformed
        if(c1.getSelectedItem()=="BTECH")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("FYBTECH");c2.addItem("SYBTECH");c2.addItem("TYBTECH");
        }
        if(c1.getSelectedItem()=="BCS")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("FYBCS");c2.addItem("SYBCS");c2.addItem("TYBCS");
        }
        if(c1.getSelectedItem()=="BCA")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("FYBCA");c2.addItem("SYBCA");c2.addItem("TYBCA");
        }
    ...
    public void connect()
    {
        ...
        {  
            ...
            "jdbc:mysql://localhost:3306/chandrika?useSSL=false&autoReconnect=true","root","crpd");  
